...
// Regexp creates a regular expression validator, using the given already-compiled *regexp.Regexp.
...
// Len creates a length validator, that checks if the length of given string is in the open interval (min, max).
